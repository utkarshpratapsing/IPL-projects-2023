...
struct_specifier:
		...
		std::cout <<nodeCount+1 << "[label=\"" << $2 << "\"]\n";		std::cout << $$ << " -> " << ++nodeCount << "\n";

std::cout <<nodeCount+1 << "[label=\"{\"]\n";		std::cout << $$ << " -> " << ++nodeCount << "\n";
		std::cout << $$ << " -> " << $4 << "\n";
...
primary_expression:
		...
		for(std::size_t i=1;i<$1.length()-1;i++) 
			if($1[i]=='"')
			new_string = new_string + std::string("\"");
			else if($1[i]=='\\')
				new_string = new_string + std::string("\\");
			
			else				new_string = new_string +$1[i];
		new_string = new_string + std::string("\" + \"\\\"\"");
		std::cout << nodeCount+1 << "[label= " << new_string << " ]\n";
		std::cout << $$ << " -> " << ++nodeCount << "\n";
